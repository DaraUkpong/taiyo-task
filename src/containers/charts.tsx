...
const ChartsPage = () => {
  ...
  //This function gets data from covid all api endpoint and is passed to the general state using the dispatch hook.
...
//Values for the line graph are generated by using the Object.keys() and Object.values operator on the allCases return object
  const data = {
    labels,
    datasets: [
      {
